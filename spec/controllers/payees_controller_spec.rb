...
RSpec.describe PayeesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested payee as @payee" do
      payee = Payee.create! valid_attributes
      get :show, {:id => payee.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested payee as @payee" do
      payee = Payee.create! valid_attributes
      get :edit, {:id => payee.to_param}, valid_session
      expect(assigns(:payee)).to eq(payee)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Payee" do
        expect {
          post :create, {:payee => valid_attributes}, valid_session
        }.to change(Payee, :count).by(1)
      end

      it "assigns a newly created payee as @payee" do
        post :create, {:payee => valid_attributes}, valid_session
        expect(assigns(:payee)).to be_a(Payee)
        expect(assigns(:payee)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payee as @payee" do
        post :create, {:payee => invalid_attributes}, valid_session
        expect(assigns(:payee)).to be_a_new(Payee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested payee" do
        payee = Payee.create! valid_attributes
        put :update, {:id => payee.to_param, :payee => new_attributes}, valid_session
        payee.reload
      ...
      it "assigns the requested payee as @payee" do
        payee = Payee.create! valid_attributes
        put :update, {:id => payee.to_param, :payee => valid_attributes}, valid_session
        expect(assigns(:payee)).to eq(payee)
      end
    ...
    describe "with invalid params" do
      it "assigns the payee as @payee" do
        payee = Payee.create! valid_attributes
        put :update, {:id => payee.to_param, :payee => invalid_attributes}, valid_session
        expect(assigns(:payee)).to eq(payee)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested payee" do
      payee = Payee.create! valid_attributes
      expect {
        delete :destroy, {:id => payee.to_param}, valid_session
      }.to change(Payee, :count).by(-1)
    end
